.class final Lcom/my/target/ek$b;
...
.method public final synthetic onBindViewHolder(Landroid/support/v7/widget/RecyclerView$ViewHolder;I)V
    ...
    check-cast p1, Lcom/my/target/ek$a;

    invoke-virtual {p1}, Lcom/my/target/ek$a;->T()Lcom/my/target/dz;
    ...
    invoke-virtual {p1}, Lcom/my/target/dz;->getSmartImageView()Lcom/my/target/bw;
    ...
    :cond_0
    invoke-virtual {p1}, Lcom/my/target/dz;->getTitleTextView()Landroid/widget/TextView;
    ...
    invoke-virtual {p1}, Lcom/my/target/dz;->getDescriptionTextView()Landroid/widget/TextView;
    ...
    invoke-virtual {p1}, Lcom/my/target/dz;->getCtaButtonView()Landroid/widget/Button;
    ...
    invoke-virtual {p1}, Lcom/my/target/dz;->getDomainTextView()Landroid/widget/TextView;
    ...
    invoke-virtual {p1}, Lcom/my/target/dz;->getRatingView()Lcom/my/target/bx;
    ...
    :goto_0
    iget-object v0, p0, Lcom/my/target/ek$b;->dk:Landroid/view/View$OnClickListener;

    invoke-virtual {p2}, Lcom/my/target/core/models/banners/f;->getClickArea()Lcom/my/target/af;

    move-result-object p2

    invoke-virtual {p1, v0, p2}, Lcom/my/target/dz;->a(Landroid/view/View$OnClickListener;Lcom/my/target/af;)V

    invoke-virtual {p1}, Lcom/my/target/dz;->getCtaButtonView()Landroid/widget/Button;

    move-result-object p1

    iget-object p2, p0, Lcom/my/target/ek$b;->dl:Landroid/view/View$OnClickListener;
...
.method public final synthetic onCreateViewHolder(Landroid/view/ViewGroup;I)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    new-instance p1, Lcom/my/target/ek$a;

    new-instance p2, Lcom/my/target/dz;

    iget-object v0, p0, Lcom/my/target/ek$b;->context:Landroid/content/Context;

    invoke-direct {p2, v0}, Lcom/my/target/dz;-><init>(Landroid/content/Context;)V

    invoke-direct {p1, p2}, Lcom/my/target/ek$a;-><init>(Lcom/my/target/dz;)V
...
.method public final synthetic onViewRecycled(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual {p1, v0, v0}, Lcom/my/target/dz;->a(Landroid/view/View$OnClickListener;Lcom/my/target/af;)V
