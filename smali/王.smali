...
.method static constructor <clinit>()V
    ...
    sput-object v0, L王;->PrefsFile:Ljava/lang/String;

    const/4 v0, 0x0

    sput-object v0, L王;->myAppContext:Landroid/content/Context;
    ...
    sput v0, L王;->myIDSpoofType:I

    const-string v0, ""

    sput-object v0, L王;->mySpoofID:Ljava/lang/String;

    const-string v0, ""

    sput-object v0, L王;->LOG_TAG:Ljava/lang/String;

    const/4 v0, 0x1

    sput-boolean v0, L王;->DEBUG:Z

    const/4 v0, 0x0

    sput-boolean v0, L王;->DUMP_STACK:Z

    sput-boolean v0, L王;->SPOOF_SIGNATURE:Z
...
.method public static DumpStack()V
    ...
    sget-boolean v0, L王;->SPOOF_SIGNATURE:Z

    if-nez v0, :cond_0

    sget-object v0, L王;->myAppContext:Landroid/content/Context;
    ...
    sget-object v3, L王;->LOG_TAG:Ljava/lang/String;
...
.method public static DumpStackIfWeShould()V
    ...
    :cond_0
    sget-boolean v0, L王;->DUMP_STACK:Z
...
.method public static Log(Ljava/lang/Object;)V
    ...
    :cond_1
    sget-object v0, L王;->LOG_TAG:Ljava/lang/String;
...
.method public static checkSignatures()I
    ...
    invoke-static {v0}, L王;->Log(Ljava/lang/Object;)V

    invoke-static {}, L王;->DumpStackIfWeShould()V
...
.method private static generateRandomDeviceID()Ljava/lang/String;
    ...
    invoke-static {v0, v1}, L王;->generateString(Ljava/lang/String;I)Ljava/lang/String;
...
.method public static getApplicationEnabledSetting(Landroid/content/pm/PackageManager;Ljava/lang/String;)I
    ...
    invoke-static {v2}, L王;->Log(Ljava/lang/Object;)V
...
.method public static getDeviceID()Ljava/lang/String;
    ...
    sget v4, L王;->myIDSpoofType:I

    const/4 v5, 0x5

    if-ne v4, v5, :cond_1

    sget-object v4, L王;->mySpoofID:Ljava/lang/String;

    :goto_0
    return-object v4

    :cond_1
    sget-object v4, L王;->myAppContext:Landroid/content/Context;

    if-nez v4, :cond_2

    const-string v4, "getDeviceID has no context, can\'t spoof device id. using fallback."

    invoke-static {v4}, L王;->Log(Ljava/lang/Object;)V
    ...
    :cond_2
    invoke-static {}, L王;->getRealDeviceID()Ljava/lang/String;
    ...
    invoke-static {}, L王;->generateRandomDeviceID()Ljava/lang/String;
    ...
    sget-object v5, L王;->PrefsFile:Ljava/lang/String;
    ...
    :pswitch_1
    invoke-static {}, L王;->getPermutedDeviceID()Ljava/lang/String;
    ...
    :pswitch_3
    sget-object v3, L王;->mySpoofID:Ljava/lang/String;
...
.method public static getInstallerPackageName(Landroid/content/pm/PackageManager;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1}, L王;->Log(Ljava/lang/Object;)V
...
.method public static getPackageInfo(Landroid/content/pm/PackageManager;Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    invoke-static {}, L王;->spoofSignatures()[Landroid/content/pm/Signature;
...
.method private static getRealDeviceID()Ljava/lang/String;
    ...
    :cond_0
    sget-object v1, L王;->myAppContext:Landroid/content/Context;
...
.method public static invokeHook(Ljava/lang/reflect/Method;Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p1, p0}, L王;->getInstallerPackageName(Landroid/content/pm/PackageManager;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p0, v1}, L王;->getPackageInfo(Landroid/content/pm/PackageManager;Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    invoke-static {p1, p0}, L王;->getApplicationEnabledSetting(Landroid/content/pm/PackageManager;Ljava/lang/String;)I
    ...
    invoke-static {p0, p1}, L王;->checkSignatures(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {v1}, L王;->shouldSpoofFileInfo(Ljava/io/File;)Z
    ...
    invoke-static {p1}, L王;->length(Ljava/io/File;)J
    ...
    invoke-static {p1}, L王;->lastModified(Ljava/io/File;)J
    ...
    invoke-static {p1}, L王;->getApplicationInfo(Landroid/content/Context;)Landroid/content/pm/ApplicationInfo;
    ...
    invoke-static {}, L王;->isDebuggerConnected()Z
...
.method public static lastModified(Ljava/io/File;)J
    ...
    sget-boolean v2, L王;->DUMP_STACK:Z
    ...
    :cond_1
    invoke-static {p0}, L王;->shouldSpoofFileInfo(Ljava/io/File;)Z
...
.method public static setAppContext(Landroid/content/Context;)V
    ...
    sput-object p0, L王;->myAppContext:Landroid/content/Context;
...
.method public static 三(Landroid/content/Context;)V
    .locals 11
...
.method public getSettingsString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {}, L王;->getDeviceID()Ljava/lang/String;
