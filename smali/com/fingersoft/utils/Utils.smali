.class public Lcom/fingersoft/utils/Utils;
.super Ljava/lang/Object;
.source "Utils.java"


# static fields
.field private static final TAG:Ljava/lang/String; = "fsutils"
...
.method public static getNetworkTime()I
    .locals 4
    ...
    invoke-static {v0, v1}, Lcom/fingersoft/game/MainActivity;->getSettingInt(Ljava/lang/String;I)I

    move-result v0

    if-lez v0, :cond_0

    const-string v1, "fsutils"

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "Using network time: "
    ...
    :cond_0
    invoke-static {}, Lcom/fingersoft/utils/Utils;->getUnixTime()I
    ...
    const-string v3, "Using local time: "
...
.method public static getUnixTime()I
    .locals 4
