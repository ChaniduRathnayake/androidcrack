...
.method private b(Z)V
    ...
    iget-boolean p1, p0, Lcom/integralads/avid/library/adcolony/AvidStateWatcher;->d:Z

    if-eqz p1, :cond_0

    invoke-direct {p0}, Lcom/integralads/avid/library/adcolony/AvidStateWatcher;->d()V

    iget-object p1, p0, Lcom/integralads/avid/library/adcolony/AvidStateWatcher;->f:Lcom/integralads/avid/library/adcolony/AvidStateWatcher$AvidStateWatcherListener;
    ...
    invoke-interface {p1, v0}, Lcom/integralads/avid/library/adcolony/AvidStateWatcher$AvidStateWatcherListener;->onAppStateChanged(Z)V
...
.method private d()V
    ...
    invoke-virtual {v1}, Lcom/integralads/avid/library/adcolony/registration/AvidAdSessionRegistry;->getInternalAvidAdSessions()Ljava/util/Collection;
    ...
    check-cast v2, Lcom/integralads/avid/library/adcolony/session/internal/InternalAvidAdSession;

    invoke-virtual {v2, v0}, Lcom/integralads/avid/library/adcolony/session/internal/InternalAvidAdSession;->setScreenMode(Z)V
...
.method public getStateWatcherListener()Lcom/integralads/avid/library/adcolony/AvidStateWatcher$AvidStateWatcherListener;
    .locals 1
...
.method public stop()V
    ...
    iput-object v0, p0, Lcom/integralads/avid/library/adcolony/AvidStateWatcher;->b:Landroid/content/Context;

    const/4 v1, 0x0

    iput-boolean v1, p0, Lcom/integralads/avid/library/adcolony/AvidStateWatcher;->d:Z

    iput-boolean v1, p0, Lcom/integralads/avid/library/adcolony/AvidStateWatcher;->e:Z

    iput-object v0, p0, Lcom/integralads/avid/library/adcolony/AvidStateWatcher;->f:Lcom/integralads/avid/library/adcolony/AvidStateWatcher$AvidStateWatcherListener;
