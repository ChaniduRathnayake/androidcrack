...
.method private b(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, p1, v2, v3}, Lcom/integralads/avid/library/adcolony/session/internal/InternalAvidAdSession;->publishNativeViewStateCommand(Ljava/lang/String;D)V
...
.method protected varargs doInBackground([Ljava/lang/Object;)Ljava/lang/String;
    ...
    iget-object p1, p0, Lcom/integralads/avid/library/adcolony/walking/async/AvidPublishAsyncTask;->state:Lorg/json/JSONObject;
    ...
    invoke-interface {v0}, Lcom/integralads/avid/library/adcolony/walking/async/AvidAsyncTask$StateProvider;->getPreviousState()Lorg/json/JSONObject;

    move-result-object v0

    invoke-static {p1, v0}, Lcom/integralads/avid/library/adcolony/utils/AvidJSONUtil;->equalStates(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z
    ...
    :cond_0
    iget-object p1, p0, Lcom/integralads/avid/library/adcolony/walking/async/AvidPublishAsyncTask;->stateProvider:Lcom/integralads/avid/library/adcolony/walking/async/AvidAsyncTask$StateProvider;

    iget-object v0, p0, Lcom/integralads/avid/library/adcolony/walking/async/AvidPublishAsyncTask;->state:Lorg/json/JSONObject;

    invoke-interface {p1, v0}, Lcom/integralads/avid/library/adcolony/walking/async/AvidAsyncTask$StateProvider;->setPreviousState(Lorg/json/JSONObject;)V

    iget-object p1, p0, Lcom/integralads/avid/library/adcolony/walking/async/AvidPublishAsyncTask;->state:Lorg/json/JSONObject;

    iget-wide v0, p0, Lcom/integralads/avid/library/adcolony/walking/async/AvidPublishAsyncTask;->timestamp:D

    invoke-static {p1, v0, v1}, Lcom/integralads/avid/library/adcolony/utils/AvidJSONUtil;->getTreeJSONObject(Lorg/json/JSONObject;D)Lorg/json/JSONObject;
